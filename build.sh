...
g++ -std=c++17 -shared -fPIC -O2 -Wall -Wextra \
    ...
    "$root/src/proxy.cpp" "$root/src/chain_lock_fix.cpp" "$root/src/carla_host.cpp" "$root/src/vst2_plugin.cpp" "$root/src/clap_plugin.cpp" "$root/src/host_thread.cpp" "$root/src/vst3_plugin.cpp" "$root/src/plugin_scan.cpp" "$root/src/plugin_state.cpp" "$root/src/fx_categories.cpp" "$root/src/plugin_window.cpp" -ldl -lX11 -lz -lpthread
