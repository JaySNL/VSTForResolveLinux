...
g++ -std=c++17 -shared -fPIC -O2 -Wall -Wextra \
    ...
    "$root/src/proxy.cpp" "$root/src/clap_host.cpp" "$root/src/carla_host.cpp" "$root/src/vst2_host.cpp" "$root/src/vst2_plugin.cpp" "$root/src/plugin_scan.cpp" "$root/src/plugin_window.cpp" -ldl -lX11
